...
window.I18N = {
  de: {
    ...
    lblOpen: "Offen (km/h)",
    lblEkfv: "eKFV (km/h)",
    speedValuesHint: "\"Entsperren\" schreibt den offenen Wert, \"Sperren\" den eKFV-Wert (Standard 20 km/h). Beide Werte merkt sich der Browser auf diesem Gerät.",
    lblMode: "Fahrmodus",
    modeEco: "eco",
    modeNormal: "normal",
    modeSport: "sport",
  ...
  en: {
    ...
    lblOpen: "Open (km/h)",
    lblEkfv: "eKFV (km/h)",
    speedValuesHint: "\"Unlock\" writes the open value, \"Lock\" the eKFV value (default 20 km/h). Both values are remembered in this browser.",
    lblMode: "Ride mode",
    modeEco: "eco",
    modeNormal: "normal",
    modeSport: "sport",
