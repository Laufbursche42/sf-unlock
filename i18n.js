...
window.I18N = {
  de: {
    ...
    lblOpen: "Offen (km/h)",
    lblEkfv: "eKFV (km/h)",
    speedValuesHint: "\"Entsperren\" und \"Sperren\" schalten zuerst in den Sportgang und setzen dort den Wert: Entsperren den offenen Wert, Sperren den eKFV-Wert (Standard 22 km/h, also 20 plus 10 Prozent Toleranz). eco und normal bleiben unangetastet. Zehntel sind erlaubt, zum Beispiel 22.4. Beide Werte merkt sich der Browser auf diesem Gerät.",
    lblMode: "Fahrmodus",
    modeEco: "eco",
    modeNormal: "normal",
    modeSport: "sport",
  ...
  en: {
    ...
    lblOpen: "Open (km/h)",
    lblEkfv: "eKFV (km/h)",
    speedValuesHint: "\"Unlock\" and \"Lock\" switch to the sport gear first and then set the value there: Unlock the open value, Lock the eKFV value (default 22 km/h, i.e. 20 plus 10 percent tolerance). eco and normal stay untouched. Tenths are allowed, for example 22.4. Both values are remembered in this browser.",
    lblMode: "Ride mode",
    modeEco: "eco",
    modeNormal: "normal",
    modeSport: "sport",
