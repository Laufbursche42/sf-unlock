...
**Verbindlich ist allein der englische Text in [LICENSE.md](LICENSE.md).** Diese Seite erklärt ihn auf Deutsch. Sie ist eine Lesehilfe und ersetzt ihn nicht. Bei Abweichungen gilt der englische Wortlaut.
...
## Die Grundlizenz in kurzen Worten

Diese Zusammenfassung ist kein Lizenztext. Sie nennt nur die Punkte, nach denen am häufigsten gefragt wird.
